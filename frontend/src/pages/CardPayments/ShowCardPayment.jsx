  ...
  return (
    ...
    >
      <div className="bg-white text-black border border-orange-500 px-4 py-2">
        ...
        <button
          className="bg-orange-500 hover:bg-orange-600 text-black border border-black hover:border-black px-4 py-2 rounded-full "
          onClick={() => handleGenerateReport(cardpayment)}
        >
