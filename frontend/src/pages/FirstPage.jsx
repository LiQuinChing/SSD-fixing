  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-4">
        ...
        <h1 className="text-4xl text-center flex-1 text-black-100 ">
          <b>Feedback</b>
        </h1>
      ...
      {loading ? (
        ...
        showType === "card" ? (
          <FeedbackCardUser feedbacks={feedbacks} handleDelete={handleDelete} />
        ) : (
          <FeedbackTable feedbacks={feedbacks} handleDelete={handleDelete} />
        )
      ) : (
